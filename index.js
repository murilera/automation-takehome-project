...
var scrape = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                search = _a.sent();
                return [4 /*yield*/, getProducts(search)];
            case 2:
                products = _a.sent();
...
var getProducts = function (searchTerm) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                page = _a.sent();
                return [4 /*yield*/, page.goto("".concat(baseUrl, "/s?k=").concat(searchTerm))];
            case 3:
                _a.sent();
                ...
                return [4 /*yield*/, Promise.all(productElements.map(function (productElement) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    productUrl = _a.sent();
                                    return [4 /*yield*/, productElement.$eval('h2', function (h2) { return h2.textContent; })];
                                case 2:
                                    productName = _a.sent();
                                    return [4 /*yield*/, productElement.$eval("//span[@class='a-offscreen']", function (span) { return span.textContent; })];
                                case 3:
                                    productPrice = _a.sent();
                                    console.log(productUrl, productName, productPrice);
                                    return [2 /*return*/, {
